...
def main():
    ...
    summary.append(f"**Full Changelog**: https://github.com/nicholaswilde/cyd-digital-clock/compare/{url_range}\n")
    ...
    try:
        url = run_cmd(f"gh release edit {latest} --draft -F /tmp/release_notes.md")
